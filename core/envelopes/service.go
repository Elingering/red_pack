...
func (r *redEnvelopeService) Get(envelopeNo string) (order *acservices.RedEnvelopeGoodsDTO) {
	panic("implement me")
}

func (r *redEnvelopeService) ListSent(userId string, page, size int) (orders []*acservices.RedEnvelopeGoodsDTO) {
	panic("implement me")
}

func (r *redEnvelopeService) ListReceived(userId string, page, size int) (items []*acservices.RedEnvelopeItemDTO) {
	panic("implement me")
}

func (r *redEnvelopeService) ListReceivable(page, size int) (orders []*acservices.RedEnvelopeGoodsDTO) {
	panic("implement me")
}

func (r *redEnvelopeService) ListItems(envelopeNo string) (items []*acservices.RedEnvelopeItemDTO) {
	panic("implement me")
}
